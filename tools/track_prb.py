...
from tracker.tracking_utils.timer import Timer
#=======
from tracker.networks_ver12 import DLASeg, BasicBlock, load_model, patchLinearAttention
from tracker.resnet import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='pretrained/bytetrack_x_mot17.pth.tar', help='model.pt path(s)')
    ...
    for ext in seqs_ext:
        for i in seqs:
            ...
            if opt.benchmark == 'sports':
                opt.source = 'datasets/sports/test/img1'
            if opt.default_parameters:
                ...
                if MOT == 20:  # MOT20
                    ...
                    if ablation:
                        ...
                        # opt.weights = r'./prb/runs/train/yolov7-prb38/weights/best.pt'
                        opt.weights = r'./pretrained/MOT17_prb.pt'
                    else:
                        # opt.weights = r'./prb/runs/train/yolov7-prb38/weights/best.pt'
                        opt.weights = r'./pretrained/MOT17_prb.pt'
